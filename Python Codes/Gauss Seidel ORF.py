...
while iteration<k and Norm>=Error:
    ...
    x2k = X2e.subs({x1:x1k,x2:x20,x3:x30,x4:x40,x5:x50,x6:x60})
    x2_col.append("{:.5g}".format(float(x2k)))
    x3k = X3e.subs({x1:x1k,x2:x2k,x3:x30,x4:x40,x5:x50,x6:x60})
    x3_col.append("{:.5g}".format(float(x3k)))
    x4k = X4e.subs({x1:x1k,x2:x2k,x3:x3k,x4:x40,x5:x50,x6:x60})
    x4_col.append("{:.5g}".format(float(x4k)))
    x5k = X5e.subs({x1:x1k,x2:x2k,x3:x3k,x4:x4k,x5:x50,x6:x60})
    x5_col.append("{:.5g}".format(float(x5k)))
    x6k = X6e.subs({x1:x1k,x2:x2k,x3:x3k,x4:x4k,x5:x5k,x6:x60})
