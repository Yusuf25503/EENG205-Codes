...
v1_eq = 1/A(1,1)*(B(1,1)-A(1,2)*v2-A(1,3)*v3);
v2_eq = 1/A(2,2)*(B(2,1)-A(2,1)*v1-A(2,3)*v3);
v3_eq = 1/A(3,3)*(B(3,1)-A(3,1)*v1-A(3,2)*v2);
...
while i<k && norm>=Error
    ...
    if i==0
        ...
        v1k = subs(v1_eq,{v2,v3},{v20,v30});
        V1(index,1) = v1k;
        v2k = subs(v2_eq,{v1,v3},{v1k,v30});
        V2(index,1) = v2k;
        v3k = subs(v3_eq,{v1,v2},{v1k,v2k});
        V3(index,1) = v3k;
        V = [v1k;v2k;v3k];
    end
